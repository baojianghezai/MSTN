...
var (
	...
	hrcCompanyJobfairApi  = api.ApiGroupApp.HrcApiGroup.CompanyJobfairApi
	hrcPersonalJobfairApi = api.ApiGroupApp.HrcApiGroup.PersonalJobfairApi
	hrcAdminOpsApi        = api.ApiGroupApp.HrcApiGroup.AdminOpsApi
)
