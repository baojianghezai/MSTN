...
type Resume struct {
	...
	Refreshtime       int64  `gorm:"column:refreshtime;index" json:"refreshtime"`              // 刷新时间
	...
	WordResumeAddtime int64  `gorm:"column:word_resume_addtime" json:"wordResumeAddtime"`
	...
	DeletedAt         int64  `gorm:"column:deleted_at;default:0" json:"deletedAt"` // 软删除（0=未删；04 §3.5 主表软删、子表保留）
}
