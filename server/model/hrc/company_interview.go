...
type CompanyInterview struct {
	...
	InterviewTime    int64  `gorm:"column:interview_time;index" json:"interviewTime"`
	...
	InterviewAddtime int64  `gorm:"column:interview_addtime;index" json:"interviewAddtime"`
