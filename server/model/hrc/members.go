...
type Members struct {
	...
	DeletedAt      *time.Time `gorm:"column:deleted_at"` // 软删除（注销合规）
}
...
type CompanyProfile struct {
	...
	Refreshtime    *time.Time `gorm:"column:refreshtime" json:"refreshtime"`
...
type MembersBind struct {
	...
	Bindingtime time.Time `gorm:"column:bindingtime"`
}
...
type MembersLog struct {
	...
	LogAddtime  time.Time `gorm:"column:log_addtime"`
