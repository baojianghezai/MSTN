...
type JobsBase struct {
	...
	Deadline        int64   `gorm:"column:deadline" json:"deadline"` // 有效期
	Refreshtime     int64   `gorm:"column:refreshtime;index" json:"refreshtime"`
	SetmealDeadline int64   `gorm:"column:setmeal_deadline;default:0" json:"setmealDeadline"`
	...
	DeletedAt       int64   `gorm:"column:deleted_at;default:0;index" json:"deletedAt"` // 逻辑删除（03 §3.1，保留投递记录）
}
